...
public class BettingstartActivity extends Activity implements
	...
	public class PopupDialog extends Dialog implements OnClickListener {
		...
		public PopupDialog(Context context) {
			...
			ok = (Button) findViewById(R.id.popup_bettingstart_start_ok);
			Button btn = (Button) findViewById(R.id.popup_bettingstart_start_cancel);
			btn.setOnClickListener(this);
			btn = (Button) findViewById(R.id.popup_bettingstart_start_close);
		}
		...
		public void onClick(View arg0) {
			if (arg0 == ok) {
				DataRequester.joinBetting(
						String.valueOf(betting.getBetting_key()), user.getId(),
						"F", BettingstartActivity.this);
			}
			this.dismiss();
		}
	}
	...
	public void onResult(HashMap<String, Object> result) {
		...
		if (type.equals("showJoinbettinglist")) {
			if (!errorOccured) {
				...
				int value = Integer.parseInt(bettingfailnumber.getText()
						.toString());
				value++;
				bettingfailnumber.setText(String.valueOf(value));
			} else {
