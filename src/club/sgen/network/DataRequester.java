...
public abstract class DataRequester {
	...
	public static void acceptFriend(final String user_id,
			final String friend_id, final String accept,
			AsyncCallback<HashMap<String, Object>> callback) {
		ArrayList<NameValuePair> params = new ArrayList<NameValuePair>();
	...
	public static void distributeProduct(final String user_id,
	...
	public static void joinBetting(final String betting_key,
			final String user_id, final String is_agree,
			AsyncCallback<HashMap<String, Object>> callback) {
		ArrayList<NameValuePair> params = new ArrayList<NameValuePair>();
		addParam(params, "betting_key", betting_key);
		addParam(params, "user_id", user_id);
		...
		execute(serverURL + "/servlets/joinBetting", params, callback,
				new DataParser("joinBetting") {
					public void addEntities(HashMap<String, Object> map,
						...
						map.put("success", data.getBoolean("success"));
						map.put("is_agree", data.getBoolean("success"));
	...
	public static void requestFriend(final String user_id,
		...
		execute(serverURL + "/servlets/requestFriend", params, callback,
				new DataParser("requestFriend") {
					public void addEntities(HashMap<String, Object> map,
						...
						try {
							map.put("success",
									toPop(data.getJSONObject("success")));
						} catch (ParseException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
