	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				DataRequester.registerID(id.getEditableText().toString(), pass
						.getEditableText().toString(), "aa@vb.com", selector
						.getFileName(), MainActivity.this);
			}
		...
		make.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(MainActivity.this,
						club.sgen.bettingpop.AddBettingActivity.class);
